...
},{"custom-event-polyfill":"../node_modules/custom-event-polyfill/custom-event-polyfill.js"}],"js/modules/game.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Game, [{
    ...
    value: function startBtnHandler() {
      ...
      var maxCountField = document.querySelector('#max-value'),
          startTime = Date.now();
      this.isStarted = true;
      this.maxInt = +maxCountField.value; // Countdown
      ...
      }, 0); // Generation and output random expressions

      this.generateNewGameIteration(); // Pressing any button
    ...
    value: function generateNewGameIteration() {
      ...
      this.expressionField.textContent = "".concat(randomInts.a, " ").concat(this.operation, " ").concat(randomInts.b); // Recording the correct answer
...
},{"custom-select":"../node_modules/custom-select/build/index.js","./modules/game":"js/modules/game.js"}],"../../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
